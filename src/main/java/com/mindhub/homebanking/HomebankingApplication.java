...
//	private PasswordEncoder passwordEncoder;
	...
	public CommandLineRunner initData(ClientRepository clientRepository,
		...
		return (args) -> {
			...
			// client accounts
			Account account = new Account("VIN001", LocalDateTime.now(), 5000);
			Account account1 = new Account("VIN002", LocalDateTime.now().plusDays(1), 7500);
			...
			Transaction transaction = new Transaction( 100, "SuperMarket shopping", LocalDateTime.now(), TransactionType.DEBIT);
			Transaction transaction1 = new Transaction( 200, "SuperMarket shopping", LocalDateTime.now(), TransactionType.CREDIT);
			...
			// client1 accounts
			Account account2 = new Account("VIN003", LocalDateTime.now(), 15000);
			Account account3 = new Account("VIN004", LocalDateTime.now().plusDays(1), 17500);
			...
			// client2 transactions
			Transaction transaction2 = new Transaction( 10, "Clothes shopping", LocalDateTime.now(), TransactionType.DEBIT);
			Transaction transaction3 = new Transaction( 50, "Tecnology shopping", LocalDateTime.now(), TransactionType.CREDIT);
			...
			// client2 accounts
			Account account4 = new Account("VIN005", LocalDateTime.now(), 2500);
			Account account5 = new Account("VIN006", LocalDateTime.now(), 3000);
			client3.addAccountSet(account4);
			client3.addAccountSet(account5);
			accountRepository.save(account4);
			accountRepository.save(account5);
			// client2 transaction
			Transaction transaction4 = new Transaction( 100, "Tecnology Shopping", LocalDateTime.now(), TransactionType.CREDIT);
			Transaction transaction5 = new Transaction( 50, "SuperMarket Shopping", LocalDateTime.now(), TransactionType.DEBIT);
			...
			automobile.addClientLoans(clientLoan3);
			mortgage.addClientLoans(clientLoan4);
